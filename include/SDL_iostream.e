...
public constant SDL_PROP_IOSTREAM_WINDOWS_HANDLE_POINTER  =  "SDL.iostream.windows.handle",
...
public constant xSDL_IOFromMem = define_c_func(sdl,"+SDL_IOFromMem",{C_POINTER,C_SIZE_T},C_POINTER)

public function SDL_IOFromMem(atom mem,atom size)
	return c_func(xSDL_IOFromMem,{mem,size})
end function

public constant SDL_PROP_IOSTREAM_MEMORY_POINTER = "SDL.iostream.memory.base",
 	SDL_PROP_IOSTREAM_MEMORY_SIZE_NUMBER = "SDL.iostream.memory.size"
 
public constant xSDL_IOFromConstMem = define_c_func(sdl,"+SDL_IOFromConstMem",{C_POINTER,C_SIZE_T},C_POINTER)

public function SDL_IOFromConstMem(atom mem,atom size)
...
public constant xSDL_CloseIO = define_c_func(sdl,"+SDL_CloseIO",{C_POINTER},C_BOOL)

public function SDL_CloseIO(atom context)
	return c_func(xSDL_CloseIO,{context})
end function

public constant xSDL_GetIOProperties = define_c_func(sdl,"+SDL_GetIOProperties",{C_POINTER},C_UINT32)
...
public function SDL_SeekIO(atom context,atom offset,SDL_IOWhence whence)
...
public constant xSDL_IOprintf = define_c_func(sdl,"+SDL_IOprintf",{C_POINTER,C_STRING,C_POINTER},C_SIZE_T)

public function SDL_IOprintf(atom context,sequence fmt,object x)
	return c_func(xSDL_IOprintf,{context,fmt,x})
end function

public constant xSDL_IOvprintf = define_c_func(sdl,"+SDL_IOvprintf",{C_POINTER,C_STRING,C_POINTER},C_SIZE_T)

public function SDL_IOvprintf(atom context,sequence fmt,object ap)
	return c_func(xSDL_IOvprintf,{context,fmt,ap})
end function

public constant xSDL_FlushIO = define_c_func(sdl,"+SDL_FlushIO",{C_POINTER},C_BOOL)

public function SDL_FlushIO(atom context)
	return c_func(xSDL_FlushIO,{context})
end function
...
public function SDL_SaveFile_IO(atom src,atom data,atom datasize,atom closeio)
	return c_func(xSDL_SaveFile_IO,{src,data,datasize,closeio})
end function

public constant xSDL_SaveFile = define_c_func(sdl,"+SDL_SaveFile",{C_STRING,C_POINTER,C_SIZE_T},C_BOOL)

public function SDL_SaveFile(sequence file,atom data,atom datasize)
	return c_func(xSDL_SaveFile,{file,data,datasize})
end function
...
public constant xSDL_ReadS8 = define_c_func(sdl,"+SDL_ReadS8",{C_POINTER,C_POINTER},C_BOOL)

public function SDL_ReadS8(atom src,atom val)
	return c_func(xSDL_ReadS8,{src,val})
end function
...
public constant xSDL_ReadU32BE = define_c_func(sdl,"+SDL_ReadU32BE",{C_POINTER,C_POINTER},C_BOOL)

public function SDL_ReadU32BE(atom src,atom val)
	return c_func(xSDL_ReadU32BE,{src,val})
end function

public constant xSDL_ReadS32BE = define_c_func(sdl,"+SDL_ReadS32BE",{C_POINTER,C_POINTER},C_BOOL)
...
public constant xSDL_WriteS8 = define_c_func(sdl,"+SDL_WriteS8",{C_POINTER,C_INT8},C_BOOL)

public function SDL_WriteS8(atom dst,atom val)
	return c_func(xSDL_WriteS8,{dst,val})
end function
...
public constant xSDL_WriteS16LE = define_c_func(sdl,"+SDL_WriteS16LE",{C_POINTER,C_INT16},C_BOOL)
